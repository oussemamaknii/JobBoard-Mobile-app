...
public class ListViewOffer extends Form {

    public ListViewOffer(Form previous) {
        ...
        for (int i = 0; i < offers.size(); i++) {
            this.add(addSeriesHolder(offers.get(i)));
        }
        this.getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> previous.showBack());

    }

    public Container addSeriesHolder(Offre_Emploi s) {
        try{
